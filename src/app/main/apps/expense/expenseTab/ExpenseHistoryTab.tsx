        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:space-x-4 py-6">
          ...
          <div className="ml-5">
            ...
            <div>
              <Button
                onClick={() =>
                  employeeExpenseImageOpen(
                    "public/assets/images/apps/ecommerce/morain-lake.jpg"
                  )
                }
              >
                <div className="rounded-2xl">
                  <img
                    ...
                    src="public/assets/images/apps/ecommerce/morain-lake.jpg"
                    alt="app-employee-expense-image"
                  />
                </div>
              </Button>
              <Modal
