    ...
    <>
      <div className="flex w-full justify-center items-center py-10">
        <div className=" h-full ">
          ...
          <div
            className="flex h-22 w-2/3
                     m-auto py-6 justify-center items-center rounded-lg bg-[#ced4da] text-white text-xl font-semibold ml-30 mr-30"
          >
            <div className="">未申請</div>
          </div>
        </div>
      </div>
      {monthList.length === 0 && (
